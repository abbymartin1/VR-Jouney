...
class GameViewController: UIViewController {
    ...
    let buttonOneArray = ["Okay", "1-3", "Commercialize it!", "Yes", "Yes", "Yes", "Real World", "Yes", "LCD", "Yes", "Yes", "2 Models", "Yes", "Locally", "Yes", "Yes", "Donate", "Yes", "Yes", "Yes"]
    let buttonTwoArray = ["", "4+", "Focus on helping PWD", "No", "No", "No", "Fictitious Environment", "No", "OLED", "No", "No", "1 Model", "No", "Non-Locally", "No", "No", "Don't Donate", "No", "No", "No"]
    ...
    func updatePoints(buttonOneSelected: Bool) {
        ...
        if (playerTotalSpotsOnBoard[playerTurnsCount] >= sectionSpots[playerSection[currentlySelectedPlayerIndex]]) {
            ...
            isCongrats = true
            if playerSection[currentlySelectedPlayerIndex] == 4 {
